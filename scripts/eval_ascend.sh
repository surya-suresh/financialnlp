...
#SBATCH --output=logs/eval_ascend_%j.out
#SBATCH --error=logs/eval_ascend_%j.err
...
case "$TASK" in
    ...
    *) echo "Usage: sbatch -M ascend scripts/eval_ascend.sh [direction|surprise] [adapter|base]"; exit 1 ;;
esac
