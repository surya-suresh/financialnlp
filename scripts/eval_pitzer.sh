...
#SBATCH --output=logs/eval_pitzer_%j.out
#SBATCH --error=logs/eval_pitzer_%j.err
...
case "$TASK" in
    ...
    *) echo "Usage: sbatch -M pitzer scripts/eval_pitzer.sh [direction|surprise] [adapter|base]"; exit 1 ;;
esac
